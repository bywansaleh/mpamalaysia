export const baseUrl = process.env.NODE_ENV === 'production' ? 'https://mpamalaysia.com' : 'http://localhost:2656';
...
export const imageLoader = (src) => {
  return process.env.NODE_ENV === 'production' ? `https://images.weserv.nl/?url=${baseUrl}${src}` : src;
};
