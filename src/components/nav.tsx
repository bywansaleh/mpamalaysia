  ...
  return (
    <nav>
      <div className="fixed inset-x-0 top-0 z-999 flex h-28 items-center">
        ...
        <div className={`
          pointer-events-none absolute inset-x-0 top-0 block h-20 bg-background
          [mask:linear-gradient(to_top,transparent,black)]
          sm:hidden
        `}
        />
              ...
              {links.map(link => (
                <li key={link.id} className="h-full">
                  <a
                    ...
                    className={cn(
                      `
                        relative flex h-full items-center justify-center px-1.5
