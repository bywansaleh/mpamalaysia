...
export default function Welcome() {
  return (
    <Section id="welcome" className="relative">
      <div className="relative container pt-48 pb-10">
        <div className="">
          <h2 className={`
        ...
        <img
          ...
          alt=""
          className={`
            pointer-events-none absolute -top-2/3 right-0 -z-10 h-[170%]
            object-contain opacity-40 hue-rotate-30 select-none
            dark:opacity-10
          `}
        />
      ...
      <div className={`
        pointer-events-none absolute inset-0 -z-10 bg-[url(/images/dot.svg)]
        bg-repeat opacity-50 invert
        [mask:linear-gradient(to_bottom,black,transparent)]
        dark:opacity-20 dark:invert-0
      `}
      />
    </Section>
  )
