      ...
      <div className='relative container'>
        <p className='mt-20 mb-10 max-w-(--breakpoint-md) text-2xl leading-[1.1]! font-light tracking-tighter text-pretty md:text-3xl'>
          <Balancer>
            ...
            the country. <span className='opacity-50'>We focus on the following six pillars.</span>
          </Balancer>
        </p>
  ...
  return (
    <RevealFade delay={index * 0.1} className='h-full'>
      <div
        ...
        <h3 className='text-lg leading-none! font-medium tracking-tighter md:text-2xl'>{pillar.title}</h3>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <a href='https://macp.com.my'>MACP</a> (Malaysia), <a href='https://wami.id/'>WAMI</a> (Indonesia),{' '}
        <a href='https://www.compass.org.sg/'>COMPASS</a> (Singapore), and others.
      </>
    ),
    icon: <Speech />,
    bg: '#2245d1',
