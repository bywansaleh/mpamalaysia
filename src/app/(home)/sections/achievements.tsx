      ...
      <Section id="achievements" className="relative scroll-m-10 py-20">
        <div className="relative container">
          ...
          <img
            ...
            alt=""
            className={`
              pointer-events-none absolute top-0 z-0 w-96 rotate-[-40deg]
              opacity-20 grayscale-[0.5] hue-rotate-30 select-none
              md:-left-40 md:opacity-90
            `}
          />
        </div>
      </Section>
  ...
  return (
    <RevealFade>
      <div className="flex flex-col">
        ...
        >
          <span className={`
            inline-block bg-linear-to-b from-brand to-brand-darker bg-clip-text
            text-transparent
          `}
          >
            {achievement.number}
