...
import type { Publisher } from './publishers.data'
    ...
    >
      <div className="container">
        ...
        <div
          className={cn(
            `
              relative flex w-full flex-col overflow-hidden rounded-3xl
              bg-gray-900 bg-linear-to-tr from-brand/20 to-brand/0 to-40% p-6
              text-white perspective-midrange
              max-md:pt-8
        ...
        >
          ...
          >
            <RevealFade>
              <div className={`
                relative z-0 flex flex-nowrap gap-6 overflow-hidden
              `}
              >
            ...
            <RevealFade delay={0.5}>
              <div className={`
                relative z-0 mt-2 flex flex-nowrap gap-6 overflow-hidden
                md:mt-6
              `}
              >
                <div className={`
  ...
  return (
    <div className={styles.publisher_icon}>
      <img
        ...
        className={cn(
          `
            inline-block size-full max-w-none object-contain opacity-60
            drop-shadow-sm invert sepia
          `,
